describe("User End Testing", () => {
  ...
  it("should login, create, edit, and delete a ticket", () => {
    ...
    cy.contains("Cypress Test Ticket")
      .parent()
      .parent()
      .find("button")
      .contains("Edit")
    ...
    cy.get('input[type="text"]')
      .first()
      .clear()
      .type("Updated Cypress Test Ticket"); // Use the appropriate input selector
    ...
    cy.contains("Updated Cypress Test Ticket", { timeout: 10000 }).should(
      "exist",
    ); // Increase the timeout to wait for the element

    // Delete the created ticket
    cy.contains("Updated Cypress Test Ticket")
      .parent()
      .parent()
      .find("button")
      .contains("Delete")
    ...
    cy.contains("Updated Cypress Test Ticket", { timeout: 10000 }).should(
      "not.exist",
    ); // Increase the timeout to wait for the element to disappear
  });
});
