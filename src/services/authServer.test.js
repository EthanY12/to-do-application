...
describe('authService', () => {
  describe('register', () => {
    it('should register a user successfully', async () => {
      ...
      expect(axios.post).toHaveBeenCalledWith('http://localhost:5000/register', { username: 'testuser', password: 'password' });
    });
    ...
    it('should throw an error when registration fails', async () => {
      ...
      await expect(authService.register('testuser', 'password')).rejects.toThrow(errorMessage);
    });
  });
  ...
  describe('login', () => {
    ...
    it('should throw an error when login fails', async () => {
      ...
      await expect(authService.login('testuser', 'wrongpassword')).rejects.toThrow(errorMessage);
    });
  });
